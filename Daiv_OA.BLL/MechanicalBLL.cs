...
{
    public class MechanicalBLL
    {

        private readonly DAL.MechanicalDAL dal = new DAL.MechanicalDAL();
        public MechanicalBLL()
        { }
        #region  成员方法
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Entity.MechanicalEntity model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public void Update(Entity.MechanicalEntity model)
        {
            dal.Update(model);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Entity.MechanicalEntity GetEntity(int id)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Entity.MechanicalEntity GetEntityByImei(string imei)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Daiv_OA.Entity.MechanicalEntity> GetModelList(string strWhere)
        {
            DataSet ds = dal.GetList(strWhere);
            List<Daiv_OA.Entity.MechanicalEntity> modelList = new List<Daiv_OA.Entity.MechanicalEntity>();
