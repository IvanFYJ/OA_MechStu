<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_List.aspx.cs" Inherits="Daiv_OA.Web.User_List" %>
                                        ...
                                        <tr>
                                            <td height="25" valign="top" style="padding-top: 2px; padding-left: 6px; padding-right: 6px;
                                                ...
                                                <asp:Repeater ID="user_repeater" runat="server"  OnItemDataBound="user_repeater_ItemDataBound">
                                                    ...
                                                    <FooterTemplate>
                                                        <tr>
                                                            <td colspan="5" style="font-size: 12pt; color: #0099ff; background-color: #e6feda;">共<asp:Label ID="lblpc" runat="server" Text="Label"></asp:Label>页 当前为第
