<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Placard_Edit.aspx.cs" Inherits="Daiv_OA.Web.Placard_Edit" %>
...
<head id="Head1" runat="server">
    <title>修改通知公告</title><script type="text/javascript" language="javascript">                             window.onerror = function () { return true; };</script>
