<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Learning_Edit.aspx.cs" Inherits="Daiv_OA.Web.Learning_Edit" %>
...
<head id="Head1" runat="server">
    <title>修改学习资料</title><script type="text/javascript" language="javascript">                             window.onerror = function () { return true; };</script>
